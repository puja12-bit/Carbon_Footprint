...
const EMISSION_FACTORS: EmissionFactor[] = [
  {
    keywords: [
      ...
      "flying to", "flying from", "air travel",
    ],
    category: "Flight",
    co2Kg: 135,
  ...
  },
  {
    ...
    category: "Transport",
    co2Kg: 4.6,
    explanation: "Petrol and diesel cars emit CO₂ from burning fuel, with additional lifecycle emissions from vehicle manufacturing. Per-km emissions depend on engine size, speed, and road conditions.",
    factors: ["Fuel combustion (85%)", "Vehicle manufacturing allocation (10%)", "Road congestion (5%)"],
  ...
  },
  {
    ...
    category: "Food",
    co2Kg: 2.0,
    explanation: "Food production accounts for about 26% of global greenhouse gas emissions. The carbon footprint of a meal depends heavily on ingredients — meat-heavy dishes have much higher footprints than plant-based ones.",
    factors: ["Ingredient production (60%)", "Processing & packaging (20%)", "Transport & distribution (15%)", "Preparation energy (5%)"],
  ...
  },
  {
    ...
    category: "Transport",
    co2Kg: 0.05,
    explanation: "Cycling is one of the lowest-carbon modes of transport. The small footprint comes from bicycle manufacturing and the extra calories burned (which require food production).",
    factors: ["Bicycle manufacturing allocation (55%)", "Additional food calories (40%)", "Maintenance (5%)"],
